...
import com.caroline.reminder.sync.ReminderUtilities;
import com.caroline.reminder.utilities.PreferenceUtilities;
...
public class MainActivity extends AppCompatActivity  implements
    ...
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            // which means the battery is currently charging.
    ...
    private void showCharging(boolean isCharging){
        if (isCharging) {
            mChargingImageView.setImageResource(R.drawable.ic_power_green_80px);
