package com.caroline.reminder.utilities;
...
import com.caroline.reminder.MainActivity;
import com.caroline.reminder.R;
import com.caroline.reminder.sync.ReminderIntentService;
import com.caroline.reminder.sync.ReminderTasks;
...
public class NotificationUtils {
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        // Pass in a unique ID for the notification and notificationBuilder.build()
        notificationManager.notify(WATER_REMINDER_NOTIFICATION_ID, notificationBuilder.build());
    }

    //Static method called ignoreReminderAction
    ...
    //Static method called drinkWaterAction
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        Intent incrementCountIntent = new Intent(context, ReminderIntentService.class);
        incrementCountIntent.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
        ...
        NotificationCompat.Action drinkWaterAction = new NotificationCompat.Action(R.drawable.ic_local_reminder_black_24px,
                "I did it!",
